...
export function GaugeDemoPage() {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <div style={{ fontSize: 13, fontWeight: 600, color: THEME.page.textPrimary }}>
            CPU Load (%)
          </div>
      ...
      >
        ...
        <div
          style={{ fontSize: 12, color: THEME.page.textSecondary, whiteSpace: "nowrap" }}
        >
          Current:{" "}
          <span
            style={{
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 11, color: THEME.page.textMuted }}>
            Semicircle · common for dashboards
          </div>
        </div>
